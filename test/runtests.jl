...
@test DateTime(parsedate("Thursday october the 13 1994", default=default)) == DateTime(1994, 10, 13)
@test DateTime(parsedate("February-03-1999", default=default)) == DateTime(1999, 2, 3)
@test DateTime(parsedate("February of 1999", default=default)) == DateTime(1999, 2, 4)
...
@test DateTime(parsedate("feb 1999", default=default)) == DateTime(1999, 2, 4)
@test DateTime(parsedate("1999", default=default)) == DateTime(1999, 7, 4)
@test DateTime(parsedate("99-02", default=default)) == DateTime(1999, 2, 4)
@test DateTime(parsedate("02-99", default=default)) == DateTime(1999, 2, 4)
...
@test DateTime(parsedate("1999 2:30", default=default)) == DateTime(1999, 7, 4, 2, 30)
@test DateTime(parsedate("99 2:30", default=default)) == DateTime(1999, 7, 4, 2, 30)
@test DateTime(parsedate("22 2:30", default=default)) == DateTime(1976, 7, 22, 2, 30)
...
@test DateTime(parsedate("2015.10.02 10:21:59.45", default=default)) == DateTime(2015, 10, 2, 10, 21, 59, 450)
...
@test DateTime(parsedate("1995-02", default=default)) == DateTime(1995, 2, 4)
@test DateTime(parsedate("1995", default=default)) == DateTime(1995, 7, 4)

@test DateTime(parsedate("1997", default=default)) == DateTime(1997, 7, 4)
@test DateTime(parsedate("1997-07", default=default)) == DateTime(1997, 7, 4)
@test DateTime(parsedate("1997-07-16", default=default)) == DateTime(1997, 7, 16)
@test DateTime(parsedate("1997-07-16T19:20+01:00", default=default)) == DateTime(1997, 7, 16, 19, 20)
@test DateTime(parsedate("1997-07-16T19:20:30+01:00", default=default)) == DateTime(1997, 7, 16, 19, 20, 30)
@test DateTime(parsedate("1997-07-16T19:20:30.45+01:00", default=default)) == DateTime(1997, 7, 16, 19, 20, 30, 450)
...
@test DateTime(parsedate("2359", default=default)) == DateTime(2359,7, 4)
@test DateTime(parsedate("23", default=default)) == DateTime(1976, 7, 23)
