...
@test isnull(tryparse(DateTime, "8! 99 Year FEB 03 Day", default=default))
@test parse(DateTime, "8! 99 Year FEB 03 Day", fuzzy=true, default=default) == DateTime(1999, 2, 3)
